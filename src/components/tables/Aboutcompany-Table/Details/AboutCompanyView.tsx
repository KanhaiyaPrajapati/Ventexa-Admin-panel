...
import { Target, Eye, ShieldCheck, Calendar, MapPin } from "lucide-react";
...
const AboutCompanyProfileView: React.FC<AboutCompanyProfileViewProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-[#1F2937] rounded-3xl w-full border border-gray-200 dark:border-gray-700 p-5">
      
      <h2 className="text-base font-semibold text-gray-900 dark:text-[#4FE7C0] mb-4">
